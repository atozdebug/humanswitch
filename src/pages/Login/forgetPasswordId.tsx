        ...
        <div className="max-w-392px mx-auto w-full pt-10 min-h-vhcalc225px flex justify-center flex-col">
          <h5 className="text-xl flex justify-center gap-5 header font-semibold  mb-4">
            ...
            <span>
              {" "}
              <img
                src="/assets/images/neww-pass.png" width={88} height={88}
              />
            </span>{" "}
          </h5>
          ...
          <p className="font-normal text-center text-gray-dark">Your new password must be different to previously used passwords.</p>
          <hr className="my-6" />
