    ...
    <>
      <div className="flex justify-between items-center w-full">
        {/* <div className="flex items-center p-2">
          {advisorImage &&
          typeof advisorImage === "string" &&
          advisorImage.trim() !== "" ? (
            <img src={advisorImage} alt="Advisor Logo" width="40" height="40" />
          ) : (
            <HiUserCircle fill="#dee0e5" className="!h-10 !w-10" />
          )}
          ...
          <div className="px-4">
            ...
            <p className="text-gray-dark text-sm">
              A short description of the chatbot and its capabilities
            </p>
          </div>
        </div> */}
        ...
        {chatId ? (
                ...
                {newMessages?.map((message, index) =>
                  message.type === "human" ? (
                    ...
                    >
                      ...
                      />{" "}
                      <p className="bg-white py-2 px-4  rounded-lg  text-sm font-normal">
                        <Markdown>{message?.content}</Markdown>
                      </p>
                    </div>
                  ) : (
                    <div key={index} className="flex gap-4  px-4 py-1 mb-6">
                      <div className="">
                        <svg
                          width="24"
                          height="22"
                      ...
                      {message?.content === "" && message.is_loading ? (
                        ...
                        >
                          <g>
                            ...
                            <circle fill="#000000" r="10" cy="50" cx="50">
                              <animate
                                begin="-0.25s"
                                keySplines="0 0.5 0.5 1;0 0.5 0.5 1;0 0.5 0.5 1;0 0.5 0.5 1"
                                values="0;0;10;10;10"
          ...
          <div className="px-4 lg:px-16 h-[80vh] overflow-y-scroll scrollbar-hide">
            ...
            <div className="px-2 pb-2 bg-[#F6F8FA] ">
              <div className="">
                <div className="flex border border-l-none border-[#E2E4E9] rounded-full py-2 px-4 bg-gray-200">
                  <input
                    type="text"
                    value={userMessage}
                    placeholder={
            ...
            <div className="grid md:grid-cols-4 sm:grid-cols-1 gap-2">
              {advisorDetails?.quick_questions?.map((question, index) => (
                <div key={index} className="bg-white p-4 mx-3 rounded-lg mt-6">
                  <div
