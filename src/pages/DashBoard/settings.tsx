                            ...
                            <div className="">
                                <form
                                    ...
                                    <div>
                                        ...
                                        <button className="rounded  mt-5 bg-span-clr hover:bg-purple-700 py-2.5 px-4 text-white font-semibold min-w-[168px] ml-3"
                                ...
                                <form className="flex flex-col max-w-md m-auto my-5">
                                    ...
                                    <div className="error rounded-lg">
                                        <p className="bg-error p-3 flex items-center text-xs font-normal gap-3 "><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        </svg> This action cannot be undone.</p>
                                    </div>
                                    <p className="text-sm text-gray-dark mt-5">All of your data, including your profile, posts, and personal information, will be permanently removed.</p>

                                    <p className="text-sm text-gray-dark mt-5"> By entering your password, you confirm that you understand and accept the consequences of deleting your account.</p>
