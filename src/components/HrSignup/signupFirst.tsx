        ...
        <form onSubmit={handleSubmit(onSubmit)} className=" pt-6">
          ...
          <label className="flex items-center space-x-2 mt-4">
            ...
            <span className="text-gray-dark text-sm">
              I agree to the <a href="/terms-and-conditions" className="text-main-heading underline font-semibold"> Terms & Conditions </a>
              and  <a href="/privacy-policy" className="text-main-heading font-semibold underline"> Privacy Policy</a>
              .
            </span>
          </label>
          {errors.agreeTerms && (
