...
const schema = yup.object().shape({
  email: yup.string().email("Please enter a valid work email address").required("Email is required"),
  password: yup
        .string()
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="form-info mt-4">
            <div>
                ...
                <input
                    ...
                    className={`shadow appearance-none border border-color: gray; rounded w-full py-2 px-3 text-gray leading-tight focus:outline-none focus:shadow-outline ${errors.email ? 'border-[#F04438]' : ''}`}
                    {...register('email')}
                />
            ...
            <div className="password my-3">
                ...
                <input
                    ...
                    type="password"
                    placeholder="Create a password"
                    className={`shadow appearance-none border border-color: gray; rounded w-full py-2 px-3 text-gray leading-tight focus:outline-none focus:shadow-outline ${errors.password ? 'border-[#F04438]' : ''}`}
                    {...register('password')}
                />
