const ForgetPasswordThird = ({ setStep }: any) => {
  return (
    <div className="Register">
      ...
      <h2 className="text-3xl font-semibold  mt-8 mb-3">Password reset</h2>
      <p className="font-normal">Your password has been successfully reset.</p>
      <p className="font-normal">Click below to log in magically.</p>
