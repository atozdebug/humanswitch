...
<button className="px-4 py-2 text-heading border border-[#E2E4E9] font-semibold rounded-lg  focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75"onClick={() => setStep((prev: number) => prev - 1)}>
    Back
</button>
</div>
...
<div className="form-3 flex flex-col max-w-md m-auto my-5">
    ...
    <h2 className="text-gray-dark text-2xl font-medium text-center">Role Selection</h2>
    <p className="gray-dark text-center">Choose your role within your company.</p>
